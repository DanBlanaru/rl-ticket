...
if prune_args.multirun:
    prune_args.init_dir = os.path.join(prune_args.init_dir, utils.detect_best_run(prune_args.init_dir))
print(prune_args.init_dir)

args, log_dir, save_dir, threads_dir, eval_log_dir = utils.prune_folders_init(prune_args)
print(log_dir)
print(save_dir)
print(threads_dir)
model_avg, model_path = utils.detect_best_path(os.path.join(prune_args.init_dir, "nets/"))
print(model_path)
...
utils.prune_net(actor_critic, prune_args, prune_round, num_prune_rounds)
