...
parser.add_argument(
    ...
    action='store_true',
    default=False,
    help="classic control discrete action environment"
)
...
evaluate(actor_critic, ob_rms, args.env_name, args.seed, 1, '', torch.device("cuda:0"), args.discrete, 50)

# actor_critic.base.prune_critic([0, 10, 10], [1, 1, 1])
# evaluate(actor_critic, ob_rms, args.env_name, args.seed, 1, '', torch.device("cuda:0"))

# print(actor_critic.base.critic_linear.weight_mask)
# quit()
